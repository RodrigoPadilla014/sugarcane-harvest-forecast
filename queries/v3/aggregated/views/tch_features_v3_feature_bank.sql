-- tch_features_v3_feature_bank.sql
--
-- Shared feature base for the TCH v3 ablation datasets.
--
-- Unit:
...
--
-- Usage:
--   CREATE OR REPLACE VIEW public.tch_features_v3_feature_bank AS ...
...
WITH raw_valid AS (
    ...
    FROM public.tch_raw_longitudinal_v3
