-- tch_features_v4_pseudoseq_core_no_radar.sql
--
-- First model-ready pseudo-sequential/tabular feature table.
--
...
SELECT
    ...
    o.optical_cycle_ndvi_obs_count,
    o.optical_ndvi_obs_count,
    o.optical_ndvi_first_obs_age,
    o.optical_ndvi_last_obs_age,
