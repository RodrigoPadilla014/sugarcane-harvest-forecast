-- tch_features_v4_temporal_bins_plus_compact.sql
--
-- Stronger v3 candidate:
--   v4 temporal age-bin wide features
--   + selected compact v2 phenology/stress features
--   + previous-cycle yield signal
--   + harvest-relative windows.

CREATE OR REPLACE VIEW public.tch_features_v4_temporal_bins_plus_compact AS
WITH wide AS (
    SELECT *
    FROM public.tch_features_v4_temporal_bins_wide
),
compact AS (
    SELECT
        cod_cg_zafra,
